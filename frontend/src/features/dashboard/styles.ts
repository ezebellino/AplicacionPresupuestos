...
export const styles = {
  ...
  mobileQuotePromptTitle: {
    color: 'var(--text)',
    fontSize: '22px',
    lineHeight: 1.18,
    margin: 0,
  },
  mobileQuotePromptActions: {
    display: 'grid',
    gap: '10px',
  },
  logoRow: {
  ...
  mobileAssistantChoiceGrid: {
    display: 'grid',
    gap: '10px',
    gridTemplateColumns: '1fr',
  },
  mobileAssistantSummary: {
    background: 'var(--panel-subtle)',
    border: '1px solid var(--border)',
    borderRadius: '8px',
    display: 'grid',
